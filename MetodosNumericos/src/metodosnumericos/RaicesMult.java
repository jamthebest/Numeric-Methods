 ...
 * @author jam2
 */
public class RaicesMult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Método de Raíces Múltiples");
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        ...
        do {
            try {
                ...
                double fx = F.Redondear(F.Evaluar(xAnt), dec);
                F.setF(deri);
                double der = F.Redondear(F.Evaluar(xAnt), dec);
                F.setF(deri2);
                double denominador = (F.Redondear(Math.pow(der, 2), dec) - (fx*F.Redondear(F.Evaluar(xAnt), dec)));
                if(denominador != 0){
                    x = F.Redondear(xAnt - ((fx*der)/denominador), dec);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RaicesMult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new RaicesMult().setVisible(true);
            }
        });
    }
